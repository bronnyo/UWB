...
/**
 * This program takes in two DNA sequences
 * and computes the best allignment between 
 * the the two DNA sequences
 *
 * @author (Krystle S Levin)
 * @version (October 24th 2017)
 */
public class LevinKrystle_HW_Loops
{
   public static void main(String[] args){
       Scanner input=new Scanner(System.in);
       System.out.print("Please enter a DNA Sequence consisting of:");
       ...
       System.out.println();
            ...
            System.out.println("Please enter a second DNA Sequence consisting:");
            System.out.println();
    ...
    //the following finds the counts and ratio of C and G
     public static void countandRatio(String sequence){
    ...
    //the following determines the complement of a sequence
    public static void complement1(String sequence){ 
   ...
   // the following computes the best allignment possibilities
